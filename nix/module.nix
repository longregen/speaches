...
in
{
  options.services.speaches = {
    ...
    package = lib.mkOption {
      ...
      description = "The speaches package to use. When using the flake's nixosModules.default, this is set automatically to the flake's pre-built package.";
    };
    ...
    openFirewall = lib.mkOption {
      type = lib.types.bool;
      default = false;
      description = "Whether to open the firewall port for speaches";
    };
  };
