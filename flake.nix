        ...
        let
          ...
          models = {
            ...
            silero-vad = nix-hug.lib.${system}.fetchModel {
              ...
              rev = "main";
              repoInfoHash = "sha256-HQFnmTnU51dUUeMVlR1vhIWDD4ARPOIk3ehDPT/3BtQ=";
              fileTreeHash = "sha256-f+/9fy13zID9i5mv7FwdwCs0oQskWJlJ7TK3VjOVI4A=";
              derivationHash = "sha256-bALIPtrPY85EkSO/o4NMS1r1aPtaneDfQ/14RHf1AIE=";
            };
            ...
            whisper-base = nix-hug.lib.${system}.fetchModel {
              ...
              repoInfoHash = "sha256-quOwzD7TEcMZl3bFBpzI6G0wEyLccQJD3i/QcsVbSy0=";
              fileTreeHash = "sha256-GYgT6udNwSgjZabqajK/i8kL3pvRPbaTC2PQdUfH0EY=";
              derivationHash = "sha256-LPqRDPq0sXCn2AY+S5qALFnFaHNkDbjxiDpJQWOxHXM=";
            };
          };
              ...
              testScript =
                if fullTest then
                  ...
                  ''
                    ...
                    print("Verifying all opentelemetry modules are importable...")
                    machine.succeed("""
