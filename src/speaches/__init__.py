...
# torch must be imported before ctranslate2 to avoid an OpenMP threading segfault.
# ctranslate2 initializes OpenMP in a way that corrupts torch's internal thread state
# if torch loads afterwards.
