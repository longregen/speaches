...
KNOWN_MODELS: dict[str, list[str]] = {
    ...
    "Systran/faster-whisper-large-v2": ["multilingual"],
    "Systran/faster-whisper-medium": ["multilingual"],
    "Systran/faster-whisper-small": ["multilingual"],
    "Systran/faster-whisper-base": ["multilingual"],
    "Systran/faster-whisper-tiny": ["multilingual"],
    "Systran/faster-whisper-tiny.en": ["en"],
    "Systran/faster-distil-whisper-large-v3": ["multilingual"],
    "Systran/faster-distil-whisper-medium.en": ["en"],
    "Systran/faster-distil-whisper-small.en": ["en"],
}
